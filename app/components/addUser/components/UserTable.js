...
export default function UserTable({ triggerGlobalRefresh }) {
  ...
  async function fetchFilteredUsers(updatedFilters) {
    ...
    try {
      const response = await fetch("https://backend-nest-app.vercel.app/users/filter", {
        method: "POST",
        headers: {
  ...
  const handleSaveUser = async (updatedData) => {
    ...
    try {
      const response = await fetch(
        `https://backend-nest-app.vercel.app/users/${updatedData.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const RefreshToken = async () => {
    ...
    try {
      const response = await fetch("https://backend-nest-app.vercel.app/auth/refresh", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const fetchData = async () => {
    ...
    try {
      let response = await fetch("https://backend-nest-app.vercel.app/users", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      if (response.status === 401) {
        ...
        if (isRefreshed) {
          ...
          const response = await fetch("https://backend-nest-app.vercel.app/users", {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${newToken}`,
  ...
  const handleDelete = async (user) => {
    ...
    try {
      let response = await fetch(`https://backend-nest-app.vercel.app/users/${user._id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  async function handleSearch(e) {
    ...
    const response = await fetch(
      `https://backend-nest-app.vercel.app/users/search?name=${search}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
