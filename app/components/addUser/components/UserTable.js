...
export default function UserTable({ triggerGlobalRefresh }) {
  ...
  async function fetchFilteredUsers(updatedFilters) {
    ...
    try {
      const response = await fetch("https://backend-nest-7n6bh4kl7-muthu7550s-projects.vercel.app/users/filter", {
        method: "POST",
        headers: {
  ...
  const handleSaveUser = async (updatedData) => {
    ...
    try {
      const response = await fetch(
        `https://backend-nest-7n6bh4kl7-muthu7550s-projects.vercel.app/users/${updatedData.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const fetchData = async () => {
    ...
    try {
      let response = await fetch("https://backend-nest-7n6bh4kl7-muthu7550s-projects.vercel.app/users", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async (user) => {
    ...
    try {
      let response = await fetch(`https://backend-nest-7n6bh4kl7-muthu7550s-projects.vercel.app/users/${user._id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  async function handleSearch(e) {
    ...
    const response = await fetch(
      `https://backend-nest-7n6bh4kl7-muthu7550s-projects.vercel.app/users/search?name=${search}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
